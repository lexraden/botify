...
class OrderItem(Base):
    ...
    # Снимок собственного названия вариации («Футболка синяя»). Без него строка
    # заказа звалась бы товарным названием, а оно принадлежит первой вариации:
    # купив вторую, человек видел бы в чеке имя чужого варианта.
    # NULL — у вариации своего названия не было или вариаций не было вовсе.
    variant_title: Mapped[str | None] = mapped_column(String(256))

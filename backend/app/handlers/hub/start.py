...
WELCOME = (
    ...
    "Здесь ты сможешь:\n"
    "• подключить своего бота (создаётся за минуту через @BotFather)\n"
    "• добавить товары и услуги в каталог\n"
    "• принимать оплату в USDT через @CryptoBot\n"
    "• собирать базу покупателей и делать рассылки\n\n"
